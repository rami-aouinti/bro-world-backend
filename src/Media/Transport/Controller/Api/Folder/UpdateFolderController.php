...
#[AsController]
#[OA\Tag(name: 'Folder')]
readonly class UpdateFolderController
{
    ...
    public function __invoke(User $loggedInUser, Folder $folder, Request $request): Response
    {
        /** @var FolderUpdate $dto */
        $dto = $this->autoMapper->map($request, FolderUpdate::class);

        $folder = $this->folderResource->update($folder->getId(), $dto, true);
